...
all_df = pd.read_csv("https://raw.githubusercontent.com/willkur/proyek_analisis_data/refs/heads/main/dashboard/df_ecommerce.csv")
all_df.sort_values(by="order_approved_at", inplace=True)
all_df.reset_index(inplace=True)

geolocation = pd.read_csv("https://raw.githubusercontent.com/willkur/proyek_analisis_data/refs/heads/main/dashboard/geolocation.csv")
...
with st.sidebar:
    ...
    st.image("https://raw.githubusercontent.com/willkur/proyek_analisis_data/refs/heads/main/dashboard/spongebob.jpg")
...
product_revenue_df = function.create_product_revenue_df()
...
fig, ax = plt.subplots(figsize=(12, 6))
colors = ["#90CAF9"] + ["#D3D3D3"] * (len(product_revenue_df) - 1)
...
ax.set_title("Top 10 Products by Total Revenue", fontsize=15)
...
ax.set_xticklabels(['{:.1f}M'.format(x/1e6) for x in current_values])
